...
local whitelist = {["Shadows_Overlord"] = true, ["Bananas_Apples2"] = true, ["Trxshba_g"] = true, ["ChemicalKit"] = true, ["ArticGamerNL"] = true, ["vxslw"] = true, ["kokrev"] = true, ["CxkeAshtray"] = true, ["Error505_UserNotFound"] = true, ["Quake_Break"] = true, ["JohnnyGhost666altn5"] = true, ["SundanceKiller"] = true, ["NuubAtEverything"] = true, ["ihaxbruv"] = true}
